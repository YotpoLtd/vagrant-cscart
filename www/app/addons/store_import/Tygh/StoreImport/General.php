...
class General
{
    ...
    {
        if (in_array($store_data['product_version'], array('4.0.1', '4.0.2'))) {
            return false;
        }
        $mapping = array(
            '4' => array(
